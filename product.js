...
function renderProduct(artwork) {
    ...
    productContent.innerHTML = `
        ...
        <div class="product-info">
            ...
            <button class="btn-inquiry" onclick="handleInquiry('${artwork.title}', '${artwork.artist}')">
...
function handleInquiry(title, artist) {
    const subject = encodeURIComponent(`Consulta sobre: ${title} - ${artist}`);
    const body = encodeURIComponent(`Hola,\n\nEstoy interesado/a en obtener más información sobre la obra "${title}" de ${artist}.\n\n¿Podrían proporcionarme detalles sobre su disponibilidad?\n\nGracias.`);

    window.location.href = `mailto:info@ono.gallery?subject=${subject}&body=${body}`;
}
